  ...
  return (
    <main className="w-full bg-linear-to-b from-base-200/40 to-transparent">
      <section className="w-full px-4 sm:px-6 lg:px-8 py-6 space-y-8">
        {/* Hero */}
        <header className="relative overflow-hidden rounded-3xl border border-base-200 bg-linear-to-br from-[#3498DB] via-[#3498DB]/80 to-[#2c7fb8] p-6 sm:p-8 shadow-sm">
          ...
          <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-4 min-w-0">
              <span className="inline-flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-white/15 text-white shadow-lg shadow-black/10">
