...
export const Pagina3: React.FC<Pagina3Props> = ({
  codigo,
  fecha,
  ciudad,
  pagareNumero,
  ...
  <Page size="A4" style={styles.page}>
    <View style={styles.borderBox}>
      ...
      <Text style={styles.paragraph}>
        ...
        la información suministrada; e) cualquier otro evento de incumplimiento
        previsto en la ley o en el contrato que dio origen a este pagaré.
      </Text>
      ...
      <Text style={styles.paragraph}>
        ...
        expresa y exigible a favor de <Text style={styles.strong}>VERIFICARTE AAA S.A.S</Text>.
      </Text>
