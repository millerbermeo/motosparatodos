...
export const Pagina6: React.FC<Pagina6Props> = ({
  codigo,
  fecha,
  ciudad,
  deudorNombre,
  ...
  <Page size="A4" style={styles.page}>
    <View style={styles.borderBox}>
      ...
      <Text style={styles.paragraph}>
        ...
        nuestras correspondientes firmas, quienes en adelante nos denominaremos{" "}
      ...
      <View style={styles.numeralesContainer}>
        <Text style={styles.numeralLine}>
          ...
          sus prórrogas, renovaciones, reestructuraciones y demás acuerdos que
          se celebren.
        </Text>
        ...
        <Text style={styles.numeralLine}>
          ...
          según el contrato o documento soporte, sin exceder los límites
        ...
        <Text style={styles.numeralLine}>
          ...
          colocar la del día en que lo diligencie.
        </Text>
        ...
        <Text style={styles.numeralLine}>
          ...
          a nuestro cargo (capital, intereses, honorarios, comisiones y demás
          conceptos).
        </Text>

        <Text style={styles.numeralLine}>
          5. Cláusula aceleratoria:{" "}
          <Text style={styles.strong}>VERIFICARTE AAA S.A.S</Text> podrá
          declarar insubsistentes los plazos de esta obligación y exigir de
          inmediato el pago total de la suma debida, junto con los intereses,
          gastos y demás valores derivados de las obligaciones accesorias que
          se hayan generado.
        </Text>

        <Text style={styles.numeralLine}>
          6. Aceptamos incondicionalmente todo traspaso, endoso o cesión que{" "}
          <Text style={styles.strong}>VERIFICARTE AAA S.A.S</Text> haga del
          presente instructivo junto con el pagaré, así como las garantías que
          lo amparan, en cuyo caso el nuevo acreedor quedará facultado para
          ejercer los mismos derechos aquí conferidos.
        </Text>
      </View>

      {/* TEXTO ANTES DE FIRMAS */}
      <Text style={styles.firmaTexto}>
        Se firma en la ciudad de ________________ a los ______ días del mes
        _________ del año __________.
      </Text>
