...
const PDFHeader: React.FC<{
  ...
  <View style={S.header} fixed>
    ...
    <View>
      <Text style={S.headerTitle}>Garantía y seguros</Text>
  ...
  return (
    <Document>
      ...
      <Page size="LETTER" style={S.page}>
        ...
        <Text style={S.centerBold}>GARANTÍA Y SEGUROS Y COMPLEMENTARIA</Text>
        ...
        {/* MOTO */}
        <Text style={S.sectionLabel}>INFORMACIÓN BÁSICA DE LA GARANTÍA Y SEGUROS Y COMPLEMENTARIA</Text>
        <View style={S.infoTable}>
      ...
      <Page size="LETTER" style={S.page}>
        ...
        <Text style={S.condText}>
          Las partes en el presente contrato son: De un lado {EMPRESA}, quien en adelante se denominará "LA COMPAÑIA", en el otro lado el adquirente, en adelante "EL TITULAR" y por último el "EL BENEFICIARIO" que será la persona que defina EL TITULAR como su beneficiario en caso de fallecer o cuando esta GARANTÍA Y SEGUROS Y COMPLEMENTARIA se pague a crédito, EL BENEFICIARIO será la empresa acreedora prendaria que aparezca en la tarjeta de propiedad de la motocicleta, con el fin de saldar el saldo insoluto que se adeude por concepto del pago de esta GARANTÍA Y SEGUROS Y COMPLEMENTARIA al momento de cualquier siniestro.
        </Text>
        <Text style={S.condText}>
