...
//   // Otros rubros (no vienen en el endpoint -> se quedan vacíos)
//   const soat: MaybeNum = undefined;
//   const matricula: MaybeNum = undefined;
//   const impuestos: MaybeNum = undefined;
...
//   const numeroSolicitud = solicitud?.codigo || solicitud?.id || cotizacion?.id || codigo_credito;

//   // Observaciones (cuota inicial y saldo) — en cotización contado usualmente 0
...
//             </li>
//             <li>
//               Cuota inicial: <span className="font-semibold text-slate-900">{fmtCOP(cuotaInicial)}</span>
//             </li>
//             <li>
//               Saldo a financiar: <span className="font-semibold text-slate-900">{fmtCOP(saldoFinanciar)}</span>
//             </li>
//             <li>
...
//                   <KV k="Código crédito" v={solicitud?.codigoCredito} />
      ...
      <div className="max-w-full mx-auto px-6 py-8 space-y-6">
        ...
        <section className="rounded-xl border border-success bg-[#F1FCF6] p-6 shadow-sm">
          ...
          <ul className="list-disc pl-6 text-sm leading-7 text-slate-700 space-y-1">
            ...
            <li>
              Cuota inicial: <span className="font-semibold text-slate-900">{fmtOptCOP(cuotaInicial)}</span>
            </li>
            <li>
