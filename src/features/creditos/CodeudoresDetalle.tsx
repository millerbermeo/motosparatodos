...
const Row: React.FC<{ label: string; value?: React.ReactNode }> = ({ label, value }) => (
    <div className="flex items-start justify-between gap-3 py-1.5">
        ...
        <span className="text-xs sm:text-sm font-medium text-right text-base-content break-words">{value}</span>
    </div>
);
                        ...
                        {codeudores.map((co: any, ci: number) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-3 px-4 sm:px-5 py-3 bg-gradient-to-r from-primary/10 to-info/10 border-b border-primary/30">
